    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compteIBAN', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='club.compte')),
            ],
            bases=('club.personatemplate',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Personal',
            fields=[
                ('personatemplate_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='club.personatemplate')),
